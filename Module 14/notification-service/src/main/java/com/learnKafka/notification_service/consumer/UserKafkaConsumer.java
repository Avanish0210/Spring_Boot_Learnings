...
import com.learnKafka.user_service.event.UserCreatedEvent;
...
public class UserKafkaConsumer {
    ...
    public void handleUserRandomTopic1(String message) {
        log.info("Received user-random-topic1: " + message);
    }

    @KafkaListener(topics = "user-random-topic")
    public void handleUserRandomTopic2(String message) {
        log.info("Received user-random-topic2: " + message);
    }

    @KafkaListener(topics = "user-random-topic")
    public void handleUserRandomTopic3(String message) {
        log.info("Received user-random-topic3: " + message);
    }
}
